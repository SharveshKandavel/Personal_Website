    ...
    >
      ...
      <div className="relative z-10 text-center px-4">
        <h1 
          ...
          style={{ animation: "scaleIn 1s cubic-bezier(.22,1,.36,1) forwards", animationDelay: "0.2s", opacity: 0 }}
        >
          SHARVESH KANDAVEL
        </h1>
        <p 
          className="mx-auto mt-6 max-w-2xl text-sm text-black/70 sm:text-base font-mono leading-relaxed tracking-widest uppercase"
          style={{ animation: "slideUpFade 0.8s ease forwards", animationDelay: "0.8s", opacity: 0 }}
        >
          Mechatronics Engineer building at the intersection of <br className="hidden sm:block" /> hardware, software, and bold ideas.
        </p>
      </div>
